// TODO: REPLACE WITH MULTI LEVEL PERLIN
// This come from https://gist.github.com/patriciogonzalezvivo/670c22f3966e662d2f83
vec4 permute(vec4 x) {
...
float cnoise(vec2 P)
{
    ...
    vec4 i = permute_mod(permute_mod(ix) + iy);
...
float fbm_perlin_2D(in vec2 p, uint octaves, float period) {
    float value = 0.0;
    float amp = 0.5;
    float freq = 1.0;
